...
顶层是你熟悉的房间：Activity、Compose、ViewModel。再往下，是负责电梯、安保、门禁和广播的系统中控。更深处，是供电、管线、地基和设备驱动。

如果只站在自己的房间里，你当然也能生活。但当电梯卡住、门禁失灵、广播延迟时，你就需要知道：问题可能不在房间里，而在整栋楼的系统里。
...
请把本节当作一次系统地图标注。你的目标不是背下所有层级，而是能把一个熟悉的类放到正确楼层。
