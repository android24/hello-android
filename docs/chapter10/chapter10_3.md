...
第一次打开 AOSP，很像站在一座陌生城市的中央车站：出口很多，线路很多，提示牌也很多。

高手不是因为他记住了每一条街，而是因为他知道自己要去哪，知道该先看站牌、再看换乘、最后再查街区细节。

这一节的任务，就是让你从“到处都是源码”变成“我知道从哪个入口开始找”。
...
请不要急着追完整调用链。先做一名冷静的导航员：看到问题，先判断应该从哪个类进入。
