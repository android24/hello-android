...
private fun HeaderCard(
    ...
    Card(
        ...
        Column(
            ...
            Text(
                text = "从手动创建对象，到 Hilt 注入；从单 app 模块，到清晰模块边界。",
...
private fun EngineeringMapCard() {
    Card(
        ...
        Column(
            ...
            SectionTitle("模块依赖方向")
            CodeLine("app -> feature-course")
            CodeLine("feature-course -> domain-course -> core-model")
            CodeLine("app -> data-course -> domain-course")
            CodeLine("data-course -> core-network")
        }
    }
}
